...
$query=$username=$created_at=$recipe=$pre_time=$cooking_time=$servings=$category=$description=$ingredients=$method="";
if($_SERVER["REQUEST_METHOD"]=="GET"){
    $query=$_GET["query"];
    $sql="SELECT * FROM blogpost WHERE CONCAT(username, created_at, recipe,pre_time, cooking_time, servings, category, origin, description, ingredients, method) REGEXP 
    '.*$query.*' ;";
    // $sql="SELECT * FROM blogpost WHERE (username, created_at, recipe,pre_time, cooking_time, servings, category, origin, description, ingredients, method) LIKE '%$query%';REGEXP '.*$query.*'";
