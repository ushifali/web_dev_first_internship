...
if(isset($_SESSION["confirm"]) && $_SESSION["confirm"] === true){
    ...
    $sql="SELECT id,username,created_at,recipe,image,description FROM blogpost WHERE username='$username';";
    ...
    echo"<div class='home-article'>
            ...
            <div class='home-article-content font4'>
             ...
             <span>$username |</span>
                ...
                <span> $time</span>
                <form action='delete.php' method='post'><button class='btn' id='deletebtn' value= '$id' name='delete'>Delete</button></form>
         </div>
        </div>
