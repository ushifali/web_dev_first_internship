...
<div class="login-box">  
       ...
       <div class="form-group">
        <input type="text" name="username" placeholder=" Your Username..." class="form-control <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $username; ?>" required>
        ...
        <div class="notify"> <a href="signup.php"> Forgot Password?</a>.
        </div>       
